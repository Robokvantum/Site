=== Interactive Map of Russia for WP ======
Contributors: html5maps
Donate link: https://www.fla-shop.com/
Tags: map, maps, interactive map, html5 map, svg map, clickable map, dealer map, html5maps, fla-shop.com, Russia
Requires at least: 3.3
Tested up to: 5.2.3
Stable tag: 3.1.4

Nice looking interactive HTML5 Map of Russia for WordPress with an option to customize the view and the behavior of the map.

== Description ==

Put an interactive high-quality HTML5 Map of Russia to your WordPress powered blog!
...
3. After that,  insert the map short code ie `[russiahtml5map id="0"]` into the text of a page or a post where you want the map to be. Short codes can be viewed on tab "Maps".
