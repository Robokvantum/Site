...
<form method="POST" oninput="TotalSoft_Cal_Out()">
	...
	<table class="Total_Soft_AMOTable">
		...
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo $TotalSoftCalCount[$i]->id;?>">
			...
			<td>0</td>
			<td><a href="http://total-soft.pe.hu/wordpress-crazy-calendar/" target="_blank" class="TS_Cal_Free_Link"><i class="Total_Soft_icon totalsoft totalsoft-eye"></i></a></td>
		...
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo $TotalSoftCalCount[$i]->id;?>">
			...
			<td>0</td>
			<td><a href="http://total-soft.pe.hu/wordpress-crazy-calendar-2/" target="_blank" class="TS_Cal_Free_Link"><i class="Total_Soft_icon totalsoft totalsoft-eye"></i></a></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		</tr>
		...
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo $TotalSoftCalCount[$i]->id;?>">
			...
			<td>0</td>
			<td><a href="http://total-soft.pe.hu/wordpress-schedule-calendar/" target="_blank" class="TS_Cal_Free_Link"><i class="Total_Soft_icon totalsoft totalsoft-eye"></i></a></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		</tr>
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo $TotalSoftCalCount[$i]->id;?>">
			...
			<td>0</td>
			<td><a href="http://total-soft.pe.hu/wordpress-schedule-calendar-2/" target="_blank" class="TS_Cal_Free_Link"><i class="Total_Soft_icon totalsoft totalsoft-eye"></i></a></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		</tr>
		...
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo $TotalSoftCalCount[$i]->id;?>">
			...
			<td>0</td>
			<td><a href="http://total-soft.pe.hu/wordpress-full-year-calendar/" target="_blank" class="TS_Cal_Free_Link"><i class="Total_Soft_icon totalsoft totalsoft-eye"></i></a></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		</tr>
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo $TotalSoftCalCount[$i]->id;?>">
			...
			<td>0</td>
			<td><a href="http://total-soft.pe.hu/wordpress-full-year-calendar-2/" target="_blank" class="TS_Cal_Free_Link"><i class="Total_Soft_icon totalsoft totalsoft-eye"></i></a></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		</tr>
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_1_DO">
				<div class="TS_Cal_Option_Divv1">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php echo __( 'Font Family', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php echo __( 'Choose the font family of the weekdays.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<select class="Total_Soft_Select" name="TotalSoftCal_DFF" id="TotalSoftCal_DFF">
								<?php for($i = 0; $i < count($TotalSoftFontGCount); $i++) { ?>
									<option value='<?php echo $TotalSoftFontGCount[$i];?>' style="font-family: <?php echo $TotalSoftFontGCount[$i];?>;"><?php echo $TotalSoftFontCount[$i];?></option>
								<?php } ?>
							</select>
